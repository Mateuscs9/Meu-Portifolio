...
test("o build apresenta os projetos, contatos e avisos das demos", async () => {
  ...
  for (const text of ["Mateus Costa Souza", "Controle de KM", "Olá, Alex", "Iniciar viagem", "NFSe Sync", "Aurora Sistemas", "Somente uma prévia do projeto", "Disponível para novas oportunidades", "em soluções digitais", "que funcionam.", "Gosto de transformar ideias em soluções úteis", "mateus.costasouza.58@gmail.com"]) {
  ...
  assert.doesNotMatch(html, />Mateus Souza</);
});
